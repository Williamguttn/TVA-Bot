...
const { fetchIdFromUsername, fetchPlayerInfo } = require("../misc/noblox");
const { errorEmbed } = require("../misc/error");
const { getUserDB } = require("../database/getUserFromDB");
const { doSql } = require("../database/doSql");
//const { BuildEmbed } = require("../misc/embeds");
...
module.exports = {
    ...
    async execute(noblox, bot, interaction, misc) {
        ...
        require("../database/registerUser").register(misc.db, playerId, interaction.user.id);
    }
};