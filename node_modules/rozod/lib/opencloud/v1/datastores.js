...
exports.getUniversesUniverseIdDatastoresDatastoreEntriesEntryVersionsVersion = exports.getUniversesUniverseIdDatastoresDatastoreEntriesEntryVersions = exports.postUniversesUniverseIdDatastoresDatastoreEntriesEntryIncrement = exports.deleteUniversesUniverseIdDatastoresDatastoreEntriesEntry = exports.postUniversesUniverseIdDatastoresDatastoreEntriesEntry = exports.getUniversesUniverseIdDatastoresDatastoreEntriesEntry = exports.getUniversesUniverseIdDatastoresDatastoreEntries = exports.getUniversesUniverseIdDatastores = void 0;
const zod_1 = require("zod");
const __1 = require("../..");
const DataStore = zod_1.z.object({
    name: zod_1.z.instanceof(File),
...
exports.getUniversesUniverseIdDatastores = (0, __1.endpoint)({
    ...
    parameters: {
        ...
        limit: zod_1.z.number().int().optional().default(1),
        prefix: zod_1.z.string().nullish(),
    },
    response: zod_1.z.object({
        data: zod_1.z.array(DataStore),
...
exports.getUniversesUniverseIdDatastoresDatastoreEntries = (0, __1.endpoint)({
    ...
    parameters: {
        universeId: zod_1.z.number().int(),
        datastoreName: zod_1.z.string().nullish(),
        scope: zod_1.z.string().nullish(),
        allScopes: zod_1.z.boolean().optional(),
        prefix: zod_1.z.string().nullish(),
        cursor: zod_1.z.string().nullish(),
        limit: zod_1.z.number().int().optional().default(16),
    },
    response: zod_1.z.object({
...
exports.getUniversesUniverseIdDatastoresDatastoreEntriesEntry = (0, __1.endpoint)({
    ...
    parameters: {
        universeId: zod_1.z.number().int(),
        datastoreName: zod_1.z.string().nullish(),
        entryKey: zod_1.z.string().nullish(),
        scope: zod_1.z.string().nullish().default('global'),
    },
    response: zod_1.z.object({}),
    errors: [],
});
...
exports.postUniversesUniverseIdDatastoresDatastoreEntriesEntry = (0, __1.endpoint)({
    ...
    parameters: {
        ...
        datastoreName: zod_1.z.string().nullish(),
        entryKey: zod_1.z.string().nullish(),
        matchVersion: zod_1.z.string().nullish(),
        exclusiveCreate: zod_1.z.boolean().optional(),
        scope: zod_1.z.string().nullish().default('global'),
        'roblox-entry-attributes': zod_1.z.string().nullish(),
        'roblox-entry-userids': zod_1.z.string().nullish(),
        'content-md5': zod_1.z.string().nullish(),
    },
    body: zod_1.z.string().max(4194304),
...
exports.postUniversesUniverseIdDatastoresDatastoreEntriesEntryIncrement = (0, __1.endpoint)({
    ...
    parameters: {
        ...
        datastoreName: zod_1.z.string().nullish(),
        entryKey: zod_1.z.string().nullish(),
        incrementBy: zod_1.z.number().int().optional().default(1),
        scope: zod_1.z.string().nullish().default('global'),
        'roblox-entry-attributes': zod_1.z.string().nullish(),
        'roblox-entry-userids': zod_1.z.string().nullish(),
    },
...
exports.getUniversesUniverseIdDatastoresDatastoreEntriesEntryVersions = (0, __1.endpoint)({
    ...
    parameters: {
        ...
        entryKey: zod_1.z.string().nullish(),
        scope: zod_1.z.string().nullish().default('global'),
        cursor: zod_1.z.string().datetime({ offset: true }).nullish(),
        startTime: zod_1.z.string().datetime({ offset: true }).nullish(),
        endTime: zod_1.z.string().nullish(),
        sortOrder: zod_1.z.string().nullish().default('Ascending'),
        limit: zod_1.z.number().int().optional().default(16),
    },
    response: zod_1.z.void(),
    errors: [
...
exports.getUniversesUniverseIdDatastoresDatastoreEntriesEntryVersionsVersion = (0, __1.endpoint)({
    ...
    parameters: {
        ...
        datastoreName: zod_1.z.string().nullish(),
        entryKey: zod_1.z.string().nullish(),
        versionId: zod_1.z.string().nullish(),
        scope: zod_1.z.string().nullish().default('global'),
    },
    response: zod_1.z.object({}),
    errors: [],
