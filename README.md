# Overview
This is the backend for the [TRU Roblox Group](https://www.roblox.com/communities/11761375/TVA-The-Vietnamese-Army#!/about). It's written in NodeJS / TS, and uses [discord.js](https://github.com/discordjs/discord.js), [express](https://github.com/expressjs/express) and [sqlite3](https://github.com/TryGhost/node-sqlite3) to host a Discord bot, API, and a database.
